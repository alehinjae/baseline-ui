...
export function Root({
  className = '',
  ...props
}: WithClass<ComponentProps<typeof BaseAccordion.Root>>) {
...
export function Item({
  className = '',
  ...props
}: WithClass<ComponentProps<typeof BaseAccordion.Item>>) {
...
export function Header({
  className = '',
  ...props
}: WithClass<ComponentProps<typeof BaseAccordion.Header>>) {
...
export function Trigger({
  className = '',
  ...props
}: WithClass<ComponentProps<typeof BaseAccordion.Trigger>>) {
...
export function Panel({
  className = '',
  ...props
}: WithClass<ComponentProps<typeof BaseAccordion.Panel>>) {
